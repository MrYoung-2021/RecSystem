...
save_path = PROCESSED_DATA_PATH / 'save/'
...
def get_user_item_time(click_df):
    ...
    user_item_time_df = (
        ...
        .reset_index()
        .rename(columns={0: 'item_item_list'})
    )
    user_item_time_dict = dict(zip(user_item_time_df['user_id'], user_item_time_df['item_item_list']))
